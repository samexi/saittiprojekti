		...
		<tr>
			...
			<td width="170">
				...
				<div class="meta_value_date_c">
					<!--<input type="text" size="2" maxlength="2" name="settings_post_meta[{0}][meta_date_value_day]" placeholder="DD" id="settings_post_meta[{0}][meta_date_value_day]" class="meta_date_value_day"  value="<?php echo $values['meta_date_value_day']; ?>" data-field-template-id="settings_post_meta[{0}][meta_date_value_day]" data-field-template-name="settings_post_meta[{0}][meta_date_value_day]" /> 
					<input type="text" size="2" maxlength="2" name="settings_post_meta[{0}][meta_date_value_month]" placeholder="MM" id="settings_post_meta[{0}][meta_date_value_month]" class="meta_date_value_month"  value="<?php echo $values['meta_date_value_month']; ?>" data-field-template-id="settings_post_meta[{0}][meta_date_value_month]" data-field-template-name="settings_post_meta[{0}][meta_date_value_month]" /> 
					<input type="text" size="4" maxlength="4" name="settings_post_meta[{0}][meta_date_value_year]" placeholder="YYYY" id="settings_post_meta[{0}][meta_date_value_year]" class="meta_date_value_year"  value="<?php echo $values['meta_date_value_year']; ?>" data-field-template-id="settings_post_meta[{0}][meta_date_value_year]" data-field-template-name="settings_post_meta[{0}][meta_date_value_year]" />-->
					...
					<label for="settings_post_meta[{0}][meta_date_value_current_date]">
						...
						<span class="hint--top hint--info" data-hint="<?php _e("this meta query is always perfomed against the current date", $this->plugin_slug); ?>"><i class="dashicons dashicons-info"></i></span>
					</label>
				</div>
			</td>
			<td>
