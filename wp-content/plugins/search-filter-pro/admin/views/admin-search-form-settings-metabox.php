					...
					*/
					...
					if(count($taxonomies)>0)
					{
						...
						foreach ($taxonomies as $taxonomy)
						{
							...
							<td>
							<input class="settings_exclude_ids" id="<?php echo esc_attr($taxonomy->name); ?>_ids" name="settings_taxonomies[<?php echo esc_attr($taxonomy->name); ?>][ids]" type="text" size="20" value="<?php echo esc_attr($tval); ?>">
