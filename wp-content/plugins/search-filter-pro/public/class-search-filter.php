...
class Search_Filter {
	...
	public function enqueue_styles()
	{
		...
		wp_enqueue_style( $this->plugin_slug . '-plugin-styles', plugins_url( 'assets/css/search-filter.min.css', __FILE__ ), array($this->plugin_slug . '-chosen-styles'), self::VERSION );
	}
	...
	public function enqueue_scripts() {
		...
		//if($sf_form_data->is_valid_form())
		//{
			wp_register_script( $this->plugin_slug . '-plugin-build', plugins_url( 'assets/js/search-filter-build.js', __FILE__ ), array( 'jquery', $this->plugin_slug . '-chosen-script' ), self::VERSION );
