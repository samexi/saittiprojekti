					...
					if($key == "category")
					{
						if(isset($val['ids']))
						{
							if($val['ids']!="")
							{
								...
								{
									$args['category__in'] = array_map("intval" , explode(",", $val['ids']));
								}
								else
								{
									$args['category__not_in'] = array_map("intval" , explode(",", $val['ids']));
								}
							}
						}
					}
					else if($key=="post_tag")
					{
						if(isset($val['ids']))
						{
							if($val['ids']!="")
							{
								if($val["include_exclude"]=="include")
								{
									$args['tag__in'] = array_map("intval" , explode(",", $val['ids']));
								}
								else
								{
									$args['tag__not_in'] = array_map("intval" , explode(",", $val['ids']));
								}
							}
						}
					}
